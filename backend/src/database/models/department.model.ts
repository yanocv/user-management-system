  ...
  implements DepartmentAttributes
{
  ...
  declare static associations: {
    employee_status: Association<Department, EmployeeStatus>;
    employee_status_dummy: Association<Department, EmployeeStatusDummy>;
  };
}

export const DepartmentInit = (sequelize: Sequelize) => {
  Department.init(
    {
      id: {
